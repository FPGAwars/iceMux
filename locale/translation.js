...
gettext('DeMux-1-4-verilog');
gettext('1-to-4 DeMultplexer (1-bit channels) Verilog implementation');
gettext('DeMux-1-4');
gettext('DeMuxF-1-4');
...
gettext('Block');
gettext('Mux-4-1-Bus');
gettext('4-to-1 Multplexer (1-bit channels). Bus. Verilog implementation');
gettext('Mux-4-1');
...
gettext('Mux-4-1');
gettext('4-to-1 Multplexer (3-bit channels)');
gettext('Mux-16-1');
gettext('Mux-2-1');
gettext('Mux-4-1');
gettext('Mux-8-1');
gettext('Mux-16-1');
gettext('Multiplexor de 16 a 1 de 4 bits');
gettext('Blocks');
gettext('Mux-2-1');
...
gettext('Mux-2-1');
gettext('Mux-32-1');
gettext('Multiplexor de 32 a 1 de 8 bits');
gettext('Blocks');
gettext('Mux-4-1');
...
gettext('Mux-4-1');
gettext('12-to-1 Multplexer (12-bit channels). Verilog implementation');
gettext('Mux-2-1');
gettext('Mux-2-1');
...
gettext('03-Mux-4-1');
gettext('04-Mux-4-1-Bus');
gettext('05-Mux-8-1');
gettext('06-Mux-8-1-Bus');
gettext('07-Demux-1-2-button-LED');
gettext('08-Demux-1-2-Bus');
gettext('09-Demux-1-4');
gettext('10-Demux-1-4-Bus');
gettext('11-Demux-1-8');
gettext('12-Demus-1-8-Bus');
gettext('000-index');
...
gettext('Switch for selecting the  \nchannel to send to the LED');
gettext('## RGB LED');
gettext('Red and blue disabled');
gettext('Negative logic');
gettext('Positive logic:   \n* ON: 1\n* OFF: 0');
gettext('Alhambra-II');
...
gettext('switches for selecting the  \nchannel to send to the LEDs');
gettext('Alhambra-II');
gettext('Nandland-go-board');
gettext('ULX3S-12F');
gettext('iCEBreaker');
...
gettext('08-deMux-1-2-Bus-button-LED');
gettext('Display8-4: Display a 8-bits value on an  4-LEDs. The sel input selects the nibble to display ');
...
gettext('iCEBreaker');
gettext('iCESugar-1.5');
gettext('10-deMux-1-4-Bus-button-LEDs');
gettext('## Example: Manual testing of the 2-bits 1-to-4 DeMux\n\nThe constant 0x3 is sent to output channels 0 - 3 depending on the  \ncounter. When the button is pressed, the counter is increased and  \nthe next LED is turned on');
gettext('**1-to-4 DeMux**');
gettext('Channel 2');
gettext('Channel 3');
gettext('10-deMux-1-4-Bus-button-LEDs');
gettext('10-deMux-1-4-Bus-button-LEDs');
...
gettext('iCEBreaker');
gettext('iCESugar-1.5');
gettext('11-deMux-1-8-button-LEDs');
gettext('## Example: Manual testing of the 1-to-8 DeMux\n\nThe constant 1 is sent to output channels 0 - 7 depending on the  \ncounter. When the button is pressed, the counter is increased and  \nthe next LED is turned on');
gettext('**1-to-8 DeMux**');
gettext('Channel 4');
gettext('Channel 5');
gettext('Channel 6');
gettext('Channel 7');
